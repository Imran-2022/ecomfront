...
const About = () => {
    return (
        <Layout title='about-us' className=' bg-[#f5f7f9] '>
            <section className="mx-60 py-24 dark:bg-gray-900">
                <div className="bg-white border gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
